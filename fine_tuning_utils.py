...
def load_checkpoint_with_conversion(ckpt_path, map_location):
...
def save_stable_diffusion_checkpoint(output_file, text_encoder, unet, ckpt_path, epochs, steps, save_dtype=None, accelerator: Accelerator = None):
  ...
  for k, v in unet_state_dict.items():
    ...
    if save_dtype is not None:
      ...
      v = v.detach().clone().to(device).to(save_dtype)
    state_dict[key] = v
